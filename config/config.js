module.exports = {
  ...
  ddosMethod: {
    ...
    slowloris: {
      name: "Slowloris",
      description: "Slowly exhaust the target's resources.",
    },
    icmpFlood: {
      name: "ICMP Flood (Ping Flood)",
      description: "Overwhelm the target with ICMP echo requests."
    }
  },
  defacementContent: {
    default: `
...
`
  ...
  onionScanner: {
    warning: "ONION SCANNER: You're about to delve into the dark web, which means you're in for a world of trouble. Seriously, turn back now.",
    educationalInfo: "Explore the deep corners of the internet. Find what you want, but don't expect to come back the same.",
    scanConfig: {
      timeout: 10000,
      maxRetries: 3
    },
  ...
  databaseNuker: {
    warning: "DATABASE NUKER: WARNING! This will completely erase a database. There's no going back. Are you sure you want to do this shit?",
    educationalInfo: "Erase databases. Watch data disappear. Feel the power, but remember the consequences.",
    confirmationWarning: "CONFIRMATION: You are about to unleash the database nuker. Type 'NUKE' to confirm. Last chance to bail out, asshole.",
    connectionSettings: {
      host: "localhost",
      port: 3306,
      user: "root",
  ...
  portScanner: {
    warning: "PORT SCANNER: Gonna check what doors are open? Hope you know what you're doing, or you'll get fucked.",
    educationalInfo: "Discover open ports on a target system. Learn about network security, or just be a prick.",
    scanConfig: {
      timeout: 2000,
      ports: "1-1024"
    },
  ...
  exploitSearcher: {
    warning: "EXPLOIT SEARCHER: Looking for weaknesses? Hope you don't get caught, because this is illegal as fuck.",
    educationalInfo: "Find vulnerabilities in software and systems. Understand cybersecurity, or just be a criminal.",
    searchConfig: {
  ...
  dataMiner: {
    warning: "DATA MINER: Gonna steal data? Hope you don't get caught, because this is a serious crime.",
    educationalInfo: "Extract valuable information from websites and databases. Become a data analyst, or just be a thief.",
    minerConfig: {
