const credentials = {
  ddos: {
    methods: [
      ...
      'ICMPv6-Flood', 'SYN-Fragment', 'XMAS-Flood',
      'HTTP-ResourceExhaustion', 'VSE-Flood', 'GAME-Flood', 'GAME-Flood2',
      'Server-Flood', 'TCP-AMP', 'GAME-Flood3', 'Rebind-Attack', 'Bypass'
    ],
    maxThreads: 65535,
    ...
    rateLimitBypass: {
      techniques: [
        ...
        'Akamai_bypass', 'custom_headers', 'browser_emulation',
        'http2_abuse', 'domain_fronting', 'tls_fingerprint', 'ua_spoof',
        'cookie_injection', 'race_condition'
      ],
      headers: {
        'X-Forwarded-For': '',
        'X-Real-IP': '',
  ...
  defacement: {
    ...
    injectionPoints: [
      '</body>', '</html>', '<head>', '<form>', '<div>',
      '<script>', '<iframe>', '<meta>', 'title', '<header>',
      '<footer>', '<nav>'
    ],
    autoReplace: true,
    imageUrls: [],
  ...
  connection: {
    ports: [
      21, 22, 23, 80, 443, 8080, 25, 110, 143, 587, 993, 995, 3306, 3389,
      27017, 6379, 5432, 1433, 1521, 33060, 5060, 5061, 8443, 9200, 28017,
      27015, 25565, 47808, 11211, 6667, 6668, 6669, 7000, 8000, 8008, 8009,
      8888, 9000, 9001, 9090, 9999, 10000, 11000, 12345, 20000, 30000, 40000,
      50000, 60000, 65535
    ],
    timeout: 500,
    scanType: [
  ...
  spam: {
    ...
    pushNotifications: {
      ...
      notificationTemplates: [
        'Noodles Alert!', 'A new Noodle is available!', 'Your Noodle is ready!',
        'Claim your free Noodle now!'
      ]
    }
  },
  phishing: {
    ...
    logCredentials: true,
    credentialLogFile: 'credentials.log',
  ...
  networkSniffing: {
    ...
    logSniffedData: true,
    sniffedDataLogFile: 'sniffed_data.log',
  ...
  socialEngineering: {
    ...
    baitingTechniques: [
      'Infected USB Drives', 'Free Software Download', 'Misconfigured Printer',
      'Fake QR Codes'
    ],
    quidProQuo: true,
    tailgating: true,
  ...
  legal: {
    termsOfService:
        'You agree to use this tool responsibly and ethically. Misuse is prohibited.',
    acceptableUsePolicy:
        'This tool should only be used for authorized penetration testing and security research.',
    disclaimer:
        'The developers are not liable for any damages caused by the misuse of this tool.'
  },
