...
document.addEventListener('DOMContentLoaded', () => {
 ...
 encryptionStatus.textContent = 'Please select a file to backup.';
 return;
 }
 ...
 log(`File "${file.name}" backed up successfully.`);
 encryptionStatus.textContent = `File "${file.name}" backed up successfully. Download started.`;
 };
