const credentials = {
  ...
  functions: {
    ...
    isSafeUrl(url) {
        // Implement more robust checks here, e.g., checking against a list of known malicious domains
        ...
        // Example: Block access to internal network addresses. This is crucial.
...
const {generateRandomIps, generateTorProxyList, generateApiKeys, generateRandomCookies, isValidUrl, isSafeUrl} = credentials.functions;
